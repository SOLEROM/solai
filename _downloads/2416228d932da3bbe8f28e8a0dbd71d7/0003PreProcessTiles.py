...
dataFolderPath  = os.path.join(os.getcwd(), DATA_FOLDER_NAME , TRAIN_FOLDER_NAME)
tilesFolderPath = os.path.join(dataFolderPath, TILES_FOLDER_NAME)

print(f"tilesFolderPath = {tilesFolderPath}")
...
print(f"dataFolderPath = {dataFolderPath}")
...
print(f"result file list = {lFile}")
